...
struct FRotator
{
	...
	FRotator _inline operator -(FRotator other) const { return FRotator{ this->Pitch - other.Pitch, this->Yaw - other.Yaw, this->Roll - other.Roll }; };
};
...
struct FVector
{
	...
	float                                              Y;                                                        // 0x0004(0x0004) (Edit)
	float                                              Z;                                                        // 0x0008(0x0004) (Edit)
	FVector _inline operator -(FVector other) const { return FVector{ this->X - other.X, this->Y - other.Y, this->Z - other.Z }; };
	FVector _inline operator +(FVector other) const { return FVector{ this->X + other.X, this->Y + other.Y, this->Z + other.Z }; };
};
