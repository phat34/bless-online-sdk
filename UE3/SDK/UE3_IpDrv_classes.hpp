...
public:
 ...
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.ClientBeaconAddressResolver");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.HTTPDownload");
		return ptr;
	}
...
{
public:
	TEnumAsByte<ELinkMode>                             LinkMode;                                                 // 0x0250(0x0001)
	TEnumAsByte<ELineMode>                             InLineMode;                                               // 0x0251(0x0001)
	TEnumAsByte<ELineMode>                             OutLineMode;                                              // 0x0252(0x0001)
	TEnumAsByte<EReceiveMode>                          ReceiveMode;                                              // 0x0253(0x0001)
	struct FPointer                                    Socket;                                                   // 0x0254(0x0008) (Const)
	int                                                Port;                                                     // 0x025C(0x0004) (Const)
	struct FPointer                                    RemoteSocket;                                             // 0x0260(0x0008) (Const)
	struct FPointer                                    PrivateResolveInfo;                                       // 0x0268(0x0008) (Const, Native)
	int                                                DataPending;                                              // 0x0270(0x0004) (Const)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.InternetLink");
		return ptr;
	}
...
{
public:
	TEnumAsByte<ELinkState>                            LinkState;                                                // 0x0274(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0275(0x0003) MISSED OFFSET
	struct FIpAddr                                     RemoteAddr;                                               // 0x0278(0x0008)
	class UClass*                                      AcceptClass;                                              // 0x0280(0x0008)
	TArray<unsigned char>                              SendFIFO;                                                 // 0x0288(0x0010) (Const, NeedCtorLink)
	struct FString                                     RecvBuf;                                                  // 0x0298(0x0010) (Const, NeedCtorLink)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.TcpLink");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpServiceBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.MCPBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineEventsInterfaceMcp");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineNewsInterfaceMcp");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineTitleFileDownloadBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineTitleFileDownloadMcp");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineTitleFileDownloadWeb");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.TitleFileDownloadCache");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpMessageBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpMessageManager");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpUserCloudFileDownload");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.MeshBeacon");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.MeshBeaconClient");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.MeshBeaconHost");
		return ptr;
	}
...
{
public:
	struct FPointer                                    VoiceEngine;                                              // 0x01BC(0x0008) (Const, Native, Transient)
	int                                                MaxLocalTalkers;                                          // 0x01C4(0x0004) (Config)
	int                                                MaxRemoteTalkers;                                         // 0x01C8(0x0004) (Config)
	unsigned long                                      bIsUsingSpeechRecognition : 1;                            // 0x01CC(0x0004) (Config)
	class UOnlineGameInterfaceImpl*                    GameInterfaceImpl;                                        // 0x01D0(0x0008)
	class UOnlineAuthInterfaceImpl*                    AuthInterfaceImpl;                                        // 0x01D8(0x0008)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineSubsystemCommonImpl");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineAuthInterfaceImpl");
		return ptr;
	}
...
public:
	...
	struct FScriptDelegate                             __OnRegisterPlayerComplete__Delegate;                     // 0x01B8(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData07[0x4];                                       // 0x01B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnUnregisterPlayerComplete__Delegate;                   // 0x01C8(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData08[0x4];                                       // 0x01C8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnStartOnlineGameComplete__Delegate;                    // 0x01D8(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData09[0x4];                                       // 0x01D8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnEndOnlineGameComplete__Delegate;                      // 0x01E8(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData10[0x4];                                       // 0x01E8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnArbitrationRegistrationComplete__Delegate;            // 0x01F8(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData11[0x4];                                       // 0x01F8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnGameInviteAccepted__Delegate;                         // 0x0208(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0208(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnRecalculateSkillRatingComplete__Delegate;             // 0x0218(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData13[0x4];                                       // 0x0218(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnMigrateOnlineGameComplete__Delegate;                  // 0x0228(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData14[0x4];                                       // 0x0228(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnJoinMigratedOnlineGameComplete__Delegate;             // 0x0238(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData15[0x4];                                       // 0x0238(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQosStatusChanged__Delegate;                           // 0x0248(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData16[0x4];                                       // 0x0248(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineGameInterfaceImpl");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlinePlaylistManager");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.PartyBeacon");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.PartyBeaconClient");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.PartyBeaconHost");
		return ptr;
	}
...
// 0x0024 (0xB0C8 - 0xB0A4)
class UTcpipConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x24];                                      // 0xB0A4(0x0024) MISSED OFFSET

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.TcpipConnection");
		return ptr;
	}
...
{
public:
	unsigned long                                      AllowPlayerPortUnreach : 1;                               // 0x01E0(0x0004) (Config)
	unsigned long                                      UnknownData00 : 31;                                       // 0x01E0(0x0001)
	unsigned long                                      LogPortUnreach : 1;                                       // 0x01E4(0x0004) (Config)
	unsigned char                                      UnknownData01[0x18];                                      // 0x01E8(0x0018) MISSED OFFSET

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.TcpNetDriver");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.WebRequest");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.WebResponse");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlinePlaylistProvider");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.UIDataStore_OnlinePlaylists");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.WebApplication");
		return ptr;
	}
...
// 0x01CC (0x0474 - 0x02A8)
class AWebServer : public ATcpLink
{
public:
	struct FString                                     ServerName;                                               // 0x02A8(0x0010) (Config, NeedCtorLink)
	struct FString                                     Applications[0xA];                                        // 0x02B8(0x0010) (Config, NeedCtorLink)
	struct FString                                     ApplicationPaths[0xA];                                    // 0x0358(0x0010) (Config, NeedCtorLink)
	unsigned long                                      bEnabled : 1;                                             // 0x03F8(0x0004) (Config)
	int                                                ListenPort;                                               // 0x03FC(0x0004) (Config)
	int                                                MaxConnections;                                           // 0x0400(0x0004) (Config)
	int                                                DefaultApplication;                                       // 0x0404(0x0004) (Config)
	int                                                ExpirationSeconds;                                        // 0x0408(0x0004) (Config)
	struct FString                                     ServerURL;                                                // 0x040C(0x0010) (NeedCtorLink)
	class UWebApplication*                             ApplicationObjects[0xA];                                  // 0x041C(0x0008)
	int                                                ConnectionCount;                                          // 0x046C(0x0004)
	int                                                ConnID;                                                   // 0x0470(0x0004)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.WebServer");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.HelloWeb");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.ImageServer");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpServiceConfig");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpClashMobBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpClashMobFileDownload");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpClashMobManager");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpGroupsBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpGroupsManager");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpIdMappingBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpIdMappingManager");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpManagedValueManagerBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpManagedValueManager");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpServerTimeBase");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpServerTimeManager");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpUserInventoryBase");
		return ptr;
	}
	...
	void PurchaseItem(const struct FString& McpId, const struct FString& SaveSlotId, const struct FString& GlobalItemId, TArray<struct FString> PurchaseItemIds, int Quantity, int StoreVersion);
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpUserInventoryManager");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0088(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAuthenticateUserComplete__Delegate;                   // 0x0098(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0098(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryUsersComplete__Delegate;                         // 0x00A8(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x4];                                       // 0x00A8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDeleteUserComplete__Delegate;                         // 0x00B8(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x4];                                       // 0x00B8(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpUserManagerBase");
		return ptr;
	}
...
{
public:
	TArray<struct FMcpUserStatus>                      UserStatuses;                                             // 0x00C8(0x0010) (NeedCtorLink)
	struct FString                                     RegisterUserMcpUrl;                                       // 0x00D8(0x0010) (Config, NeedCtorLink)
	...
	struct FString                                     FacebookAuthUrl;                                          // 0x0128(0x0010) (Config, NeedCtorLink)
	struct FString                                     McpAuthUrl;                                               // 0x0138(0x0010) (Config, NeedCtorLink)
	TArray<class UHttpRequestInterface*>               RegisterUserRequests;                                     // 0x0148(0x0010) (NeedCtorLink)
	TArray<class UHttpRequestInterface*>               QueryUsersRequests;                                       // 0x0158(0x0010) (NeedCtorLink)
	TArray<struct FUserRequest>                        DeleteUserRequests;                                       // 0x0168(0x0010) (NeedCtorLink)
	TArray<class UHttpRequestInterface*>               AuthUserRequests;                                         // 0x0178(0x0010) (NeedCtorLink)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.McpUserManager");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.OnlineImageDownloaderWeb");
		return ptr;
	}
...
{
public:
	class AWebServer*                                  WebServer;                                                // 0x02A8(0x0008)
	struct FString                                     ReceivedData;                                             // 0x02B0(0x0010) (NeedCtorLink)
	class UWebRequest*                                 Request;                                                  // 0x02C0(0x0008)
	class UWebResponse*                                Response;                                                 // 0x02C8(0x0008)
	class UWebApplication*                             Application;                                              // 0x02D0(0x0008)
	unsigned long                                      bDelayCleanup : 1;                                        // 0x02D8(0x0004)
	int                                                RawBytesExpecting;                                        // 0x02DC(0x0004)
	int                                                MaxValueLength;                                           // 0x02E0(0x0004) (Config)
	int                                                MaxLineLength;                                            // 0x02E4(0x0004) (Config)
	int                                                ConnID;                                                   // 0x02E8(0x0004)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class IpDrv.WebConnection");
		return ptr;
	}
