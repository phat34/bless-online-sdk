...
#include "UE3_AkAudio_structs.hpp"
...
public:
 ...
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.ActorFactoryAkAmbientSound");
		return ptr;
	}
...
{
public:
	unsigned long                                      bAutoPlay : 1;                                            // 0x0258(0x0004)
	unsigned long                                      StopWhenOwnerIsDestroyed : 1;                             // 0x0258(0x0004) (Edit)
	unsigned long                                      bIsPlaying : 1;                                           // 0x0258(0x0004) (Transient)
	class UAkEvent*                                    PlayEvent;                                                // 0x025C(0x0008) (Edit)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.AkAmbientSound");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.AkAudioDevice");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.AkComponent");
		return ptr;
	}
...
{
public:
	TArray<struct FAkEventTrackKey>                    AkEvents;                                                 // 0x00C0(0x0010) (NeedCtorLink)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.InterpTrackAkEvent");
		return ptr;
	}
...
{
public:
	struct FString                                     Param;                                                    // 0x00D8(0x0010) (Edit, NeedCtorLink)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.InterpTrackAkRTPC");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.InterpTrackInstAkEvent");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.InterpTrackInstAkRTPC");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkClearBanks");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkLoadBank");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkPostEvent");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkPostTrigger");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkSetRTPCValue");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkSetState");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkSetSwitch");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkStartAmbientSound");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class AkAudio.SeqAct_AkStopAll");
		return ptr;
	}
