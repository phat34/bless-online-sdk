...
struct FMcpClashMobChallengeEvent
{
	...
	unsigned long                                      has_started : 1;                                          // 0x0084(0x0004)
	unsigned long                                      is_visible : 1;                                           // 0x0084(0x0004)
	unsigned long                                      has_completed : 1;                                        // 0x0084(0x0004)
	unsigned long                                      was_successful : 1;                                       // 0x0084(0x0004)
	...
	struct FString                                     twitter_id;                                               // 0x00CC(0x0010) (NeedCtorLink)
};
...
struct FMcpUserStatus
{
	...
	unsigned long                                      bIsBanned : 1;                                            // 0x0064(0x0004)
};
