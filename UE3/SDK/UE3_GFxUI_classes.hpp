...
public:
 ...
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxEngine");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxFSCmdHandler");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxInteraction");
		return ptr;
	}
...
public:
	...
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                                // 0x01D4(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x4];                                       // 0x01D4(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxMoviePlayer");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxObject");
		return ptr;
	}
...
{
public:
	struct FScriptDelegate                             __EventListener__Delegate;                                // 0x00A0(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x4];                                       // 0x00A0(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxClikWidget");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxRawData");
		return ptr;
	}
...
public:
	...
	struct FString                                     SourceFile;                                               // 0x00A4(0x0010) (Edit, NeedCtorLink)
	int                                                PackTextureSize;                                          // 0x00B4(0x0004) (Edit)
	TEnumAsByte<EFlashTextureRescale>                  TextureRescale;                                           // 0x00B8(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00B9(0x0003) MISSED OFFSET
	struct FString                                     TextureFormat;                                            // 0x00BC(0x0010) (Edit, EditConst, NeedCtorLink)
	struct FString                                     SourceFileTimestamp;                                      // 0x00CC(0x0010) (Edit, EditConst, NeedCtorLink)
	int                                                RTTextures;                                               // 0x00DC(0x0004)
	int                                                RTVideoTextures;                                          // 0x00E0(0x0004)
	struct FQWord                                      ImportTimeStamp;                                          // 0x00E4(0x0008) (Const, Transient)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.SwfMovie");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.FlashMovie");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxAction_CloseMovie");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxAction_GetVariable");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxAction_Invoke");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxAction_OpenMovie");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxAction_SetCaptureKeys");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxAction_SetVariable");
		return ptr;
	}
...
{
public:
	class USwfMovie*                                   Movie;                                                    // 0x0170(0x0008) (Edit)
	struct FString                                     FSCommand;                                                // 0x0178(0x0010) (Edit, NeedCtorLink)
	class UGFxFSCmdHandler_Kismet*                     Handler;                                                  // 0x0188(0x0008)

	static UClass* StaticClass()
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxEvent_FSCommand");
		return ptr;
	}
...
public:
	...
	{
		static UClass* ptr = nullptr; 
 if (!ptr) ptr = UObject::FindClass("Class GFxUI.GFxFSCmdHandler_Kismet");
		return ptr;
	}
